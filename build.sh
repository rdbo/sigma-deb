...
fakeroot checkinstall \
    ...
    --recommends="xinit, xrandr, dunst, libnotify-bin, feh, vim, maim, man, pulseaudio, pulseaudio-utils, papirus-icon-theme, adwaita-icon-theme, firefox-esr, gimp, inkscape, libreoffice-gnome, ssh, rsync, screen, git, wget, curl, perl, gawk, sed, coreutils, g++, make, cmake, build-essentials, checkinstall, fakeroot, live-build, python3, python3-pip, openjdk-11-jdk, openjdk-17-jdk, tor, torbrowser-launcher, weechat, tar, gzip, xz-utils, p7zip-full, p7zip-rar, ntfs-3g, lxappearance, pulsemixer, wireguard-tools, openvpn, openssl, gnupg, iwd, poppler-utils, imagemagick, mpv, apache2, libapache2-mod-php, postgresql, mariadb-server, mariadb-client, keepassxc, x11-xkb-utils, x11-xserver-utils, x11-utils, shotcut, chromium, qemu-system, ovmf, blender, bluez, bluez-tools, obs-studio, audacity, xfe" \
