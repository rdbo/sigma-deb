...
fakeroot checkinstall \
    ...
    --recommends="xinit, xrandr, dunst, libnotify-bin, feh, vim, maim, man, pulseaudio, pulseaudio-utils, papirus-icon-theme, adwaita-icon-theme, firefox-esr, gimp, inkscape, libreoffice-gnome, ssh, git, wget, curl, g++, build-essentials, checkinstall, fakeroot, live-build, python3, openjdk-11-jdk, openjdk-17-jdk, tor, torbrowser-launcher, weechat, tar, gzip, xz-utils, p7zip-full, p7zip-rar, ntfs-3g, lxappearance, pavucontrol, wireguard-tools, openvpn, openssl, gnupg, iwd, poppler-utils, imagemagick, mpv, apache2, libapache2-mod-php, postgresql, mariadb-server, mariadb-client, keepassxc, x11-xkb-utils, x11-xserver-utils, x11-utils, kdenlive, chromium" \
